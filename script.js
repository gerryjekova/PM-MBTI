...
document.addEventListener('DOMContentLoaded', function() {
    // Add Pageclip form submission handling
    const userForm = document.getElementById("userSubmissionForm");
    if (userForm) {
        userForm.addEventListener("submit", function(e) {
            ...
            const submitButton = userForm.querySelector('.pageclip-form__submit span');
            if (submitButton) {
    ...
    // Listen for Pageclip success event
    document.addEventListener('pageclip-form-success', function() {
        ...
        if (userForm) {
            ...
            userForm.parentNode.insertBefore(successMsg, userForm.nextSibling);
            
            // Reset button text if it exists
            const submitButton = userForm.querySelector('.pageclip-form__submit span');
            if (submitButton) {
                submitButton.textContent = "Send My Results";
            }
